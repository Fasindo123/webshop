...
class ACL
{
	...
	public static $role_pages = array(
			'admin' =>
						array(
							'items' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'users' => array('list','view','add','edit', 'editfield','delete','accountedit','accountview','userregister'),
							'categories' => array('list','view','add','edit', 'editfield','delete'),
							'favorites' => array('list','view','add','edit', 'editfield','delete'),
							'in_cart_items' => array('list','view','add','edit', 'editfield','delete')
						),
		
			'user' =>
						array(
							'users' => array('accountedit','accountview','userregister')
						)
		);
