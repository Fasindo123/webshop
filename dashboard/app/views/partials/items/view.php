...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Termék megtekintése</h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-price">
                                        <th class="title"> Ár: </th>
                                        <td class="value"> <?php echo $data['price']; ?></td>
                                    </tr>
                                    <tr  class="td-stock">
                                        <th class="title"> Készleten: </th>
                                        <td class="value"> <?php echo $data['stock']; ?></td>
                                    </tr>
                                    <tr  class="td-images">
                                        <th class="title"> Képek: </th>
                                        <td class="value"><?php Html :: page_img($data['images'],400,400,5); ?></td>
                                    </tr>
                                    <tr  class="td-category_id">
                                        <th class="title"> Kategória: </th>
                                        <td class="value">
                                            <a size="sm" class="btn btn-link page-modal" href="<?php print_link("categories/view/" . urlencode($data['category_id'])) ?>">
                                    ...
                                    <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                        ...
                                        <a class="dropdown-item export-link-btn" data-format="pdf" href="<?php print_link($export_pdf_link); ?>" target="_blank">
                                            ...
                                            <a class="dropdown-item export-link-btn" data-format="word" href="<?php print_link($export_word_link); ?>" target="_blank">
                                                ...
                                                <?php } ?>
                                                <?php if($can_delete){ ?>
                                                <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("items/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Biztosan törölni szeretnéd ezt a terméket?" data-display-style="modal">
