...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Favorites</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("favorites/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-user_id" name="user_id"  placeholder="Select a value ..."    class="custom-select" >
                                                    ...
                                                    <?php
                                                    $rec = $data['user_id'];
                                                    $user_id_options = $comp_model -> favorites_user_id_option_list();
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-item_id" name="item_id"  placeholder="Select a value ..."    class="custom-select" >
                                                    ...
                                                    <?php
                                                    $rec = $data['item_id'];
                                                    $item_id_options = $comp_model -> favorites_item_id_option_list();
